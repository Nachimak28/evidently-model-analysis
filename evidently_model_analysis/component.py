...
class EvidentlyModelAnalysis(L.LightningWork):
    def __init__(self, *args,
                ...
                parallel: bool=False,
                report_parent_path: str=None,
                **kwargs) -> None:
        """
        A Simple Lightning component which uses EvidentlyAI to generate an interactive model dashboard for train and test data.
        ...
        ----------
            ...
            prediction_column_name: str (optional)
                Name of the column consisting model predictions in train and test dataframes - must be same for both
            task_type : str
    ...
    def build_dashboard(self, train_df: Optional[Payload]=None, test_df: Optional[Payload]=None):
        """
        ...
        self._col_map.prediction = self.prediction_column_name
        ...
        model_performance_dashboard.calculate(self._train_df, self._test_df, column_mapping=self._col_map)
        ...
        model_performance_dashboard.save(report_path)
    ...
    def run(self, train_df: Optional[Payload]=None, test_df: Optional[Payload]=None) -> None:
        """
        Builds the EvidentlyAI model dashboard. The run method allows passing of the data arguments 
